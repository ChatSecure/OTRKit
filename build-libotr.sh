#!/bin/bash
#  Builds libotr for all three current iPhone targets: iPhoneSimulator-i386,
...
# These are the libs that comprise libotr.
OUTPUT_LIBS="libotr.a"
